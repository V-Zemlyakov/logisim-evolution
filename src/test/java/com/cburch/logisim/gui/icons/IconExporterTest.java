...
public class IconExporterTest {
  ...
  void testExportIconToAllFormats() throws Exception {
    var className = System.getProperty("iconClassName");
    var baseName = System.getProperty("iconBaseName");

    if (className == null) className = System.getProperty("systemProp.iconClassName");
    if (baseName == null) baseName = System.getProperty("systemProp.iconBaseName");

    if (className == null) className = System.getProperty("org.gradle.project.iconClassName");
    if (baseName == null) baseName = System.getProperty("org.gradle.project.iconBaseName");

    if (className == null) className = System.getenv("ICON_CLASS_NAME");
    if (baseName == null) baseName = System.getenv("ICON_BASE_NAME");
    ...
    if (className != null && baseName != null) {
      ...
      final var icon = new TwoPinLedIcon();
      exportIconToAllFormats(icon, "twopinled");
    }
  }
}
