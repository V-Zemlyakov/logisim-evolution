...
public class WiringLibrary extends Library {
  ...
  private static final FactoryDescription[] DESCRIPTIONS = {
    new FactoryDescription(Power.class, S.getter("powerComponent")),
    new FactoryDescription(Ground.class, S.getter("groundComponent")),
    new FactoryDescription(DoNotConnect.class, S.getter("noConnectionComponent")),
    new FactoryDescription(Transistor.class, S.getter("transistorComponent")),
    new FactoryDescription(
        TransmissionGate.class, S.getter("transmissionGateComponent")),
    new FactoryDescription(BitExtender.class, S.getter("extenderComponent")),
  };
